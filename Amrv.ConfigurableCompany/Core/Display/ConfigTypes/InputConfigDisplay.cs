...
{
    public abstract class InputConfigDisplay : ConfigDisplay
    {
        public const int MAX_CHARACTERS = 17;
        ...
        {
            GameObject container = UnityEngine.Object.Instantiate(MenuPresets.Config_Input);
