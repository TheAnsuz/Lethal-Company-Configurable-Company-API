...
{
    [Obsolete("Use CTypes.ArraySingleOption(options)")]
    public class ListConfigurationType(params object[] options) : ConfigurationType
    {
        private readonly CType _ctype = CTypes.ArraySingleOption(options);
