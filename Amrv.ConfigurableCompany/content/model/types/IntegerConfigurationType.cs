...
{
    [Obsolete("Use CTypes.WholeNumber(min, max)")]
    public class IntegerConfigurationType(int min = int.MinValue, int max = int.MaxValue) : ConfigurationType
    {
        private readonly CType _ctype = CTypes.WholeNumber(min, max);
