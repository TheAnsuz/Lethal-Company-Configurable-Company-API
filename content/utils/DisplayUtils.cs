...
namespace Amrv.ConfigurableCompany.content.utils
{
    public class DisplayUtils
    {
        ...
        public static readonly Navigation NO_NAVIGATION = new()
        {
        ...
        public static string FixTooltip(string tooltip)
        {
            StringBuilder builder = new();

            string[] lines = tooltip.Split(LINE_SEPARATOR);
            ...
            for (int i = 0; i < lines.Length; i++)
            {
                ...
                if (lines[i].Length > TOOLTIP_MAX_LINE_LENGTH)
                {
                    ...
                    builder.Append(lines[i]).Append(LINE_SEPARATOR);
